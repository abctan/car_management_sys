...
int shellExtRun(shellFunction function, int argc, char *argv[])
{
    ...
    case 1:
        ...
        // break;
    case 2:
        return ((shellFunction1)function)(shellExtParsePara(argv[1]));
        // break;
    case 3:
        return ((shellFunction2)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]));
        // break;
    case 4:
        return ((shellFunction3)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]),
                                                            shellExtParsePara(argv[3]));
        // break;
    case 5:
        return ((shellFunction4)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]),
                                                            shellExtParsePara(argv[3]), shellExtParsePara(argv[4]));
        // break;
    case 6:
        return ((shellFunction5)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]),
                                                            shellExtParsePara(argv[3]), shellExtParsePara(argv[4]),
                                                            shellExtParsePara(argv[5]));
        // break;
    case 7:
        return ((shellFunction6)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]),
                                                            shellExtParsePara(argv[3]), shellExtParsePara(argv[4]),
                                                            shellExtParsePara(argv[5]), shellExtParsePara(argv[6]));
        // break;
    case 8:
        return ((shellFunction7)function)(shellExtParsePara(argv[1]), shellExtParsePara(argv[2]),
                                                            shellExtParsePara(argv[3]), shellExtParsePara(argv[4]),
                                                            shellExtParsePara(argv[5]), shellExtParsePara(argv[6]),
