...
typedef int (*shellFunction1)(unsigned int);
typedef int (*shellFunction2)(unsigned int, unsigned int);
typedef int (*shellFunction3)(unsigned int, unsigned int, unsigned int);
typedef int (*shellFunction4)(unsigned int, unsigned int, unsigned int, unsigned int);
typedef int (*shellFunction5)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
typedef int (*shellFunction6)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
typedef int (*shellFunction7)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
typedef int (*shellFunction8)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
/**
 * @brief shell输入状态
 * 
 */
